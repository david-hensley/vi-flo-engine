# Spatial precipitation interpolation
...
# Define AOI by Virgin Islands bounding box, includes Tortola
aoi <- data.frame(lat = c(17.658, 18.47), lon = c(-64.540, -65.105))
kriged.precip <- kriging.rain(wd, aoi, 100)
